  ...
  return (
    ...
    <main>
        ...
        <section class="banner__inner-page bg-image pt-160 pb-160 bg-image" style={{backgroundImage:"url('/images/banner/banner-inner-page.jpg')"}}
           >
            <div class="container">
                <h2 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Event Single</h2>
                ...
                <div class="row g-4">
                    <div class="col-lg-8 order-2 order-lg-1">
                        <div class="blog__item blog-single__left-item shadow-none">
                            <div class="image">
                                <img src="/images/event/event-single-image.jpg" alt="image"/>
                    ...
                    <div class="col-lg-4 order-1 order-lg-2">
                        <div class="event-single__right-item">
                            <div class="item shadow mb-30 text-center">
                                <img src="/images/project/user.png" alt="image"/>
