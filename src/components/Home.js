    ...
    <main>
        ...
        <section className="video-area">
            <div className="row g-0">
                ...
                <div className="col-md-7">
                    <div className="video__right-item bg-image pt-120 pb-120 pl-80" style={{backgroundImage: "url('/images/video/video-right-image.jpg')"}}
                       >
                        <div className="video__content">
                            <div className="section-header mb-40">
                                <h5 className="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                                    <i className="fa-regular fa-angles-left pe-1"></i> Watch Videos <i
                                        className="fa-regular fa-angles-right ps-1"></i>
                                </h5>
                                ...
                                <p className="text-white wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">It
                            ...
                            <div className="d-flex align-items-center justify-content-between gap-4 flex-wrap">
                                <div className="info wow fadeInDown" data-wow-delay="00ms" data-wow-duration="1500ms">
                                    <h2 className="text-white"><span className="count text-white">50</span>%</h2>
                                    <p className="mt-10 text-white">kids Need Help</p>
                                </div>
                                <div className="info wow fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                                    <h2 className="text-white">$<span className="count text-white">500</span>k</h2>
                                    <p className="mt-10 text-white">Our Goal</p>
                                </div>
                                <div className="info wow fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                                    <h2 className="text-white">$<span className="count text-white">125</span>k</h2>
                                    <p className="mt-10 text-white">Raised Now</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section className="event-area pt-120 pb-120 bg-image" style={{backgroundImage: "url('/images/bg/event-bg-image.jpg')"}} >
            <div className="container-fluid">
                <div className="section-header text-center mb-60">
                    <h5 className="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <i className="fa-regular fa-angles-left pe-1"></i> Our EVENT <i
                            className="fa-regular fa-angles-right ps-1"></i>
                    </h5>
                    <h2 className="text-white wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Numerous
                        Events Gathering</h2>
                </div>
                <div className="row g-4">
                    <div className="col-xl-6 wow fadeInDown" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div className="event__item h-100">
                            <div className="image h-100">
                                <img className="h-100" src="images/event/event-image1.jpg" alt="image"/>
                            </div>
                            <div className="event__content">
                                        ...
                                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                            ...
                                            <g clipPath="url(#clip0_66_78)">
                                                <path
                                                    ...
                                                    stroke="#F74F22" strokeWidth="2" strokeLinecap="round"
                                ...
                                <h3 className="mb-4"><a href="event-single.html" className="primary-hover">Rebecca's Album
                                        Supports
                                        Needy</a>
                                </h3>
                                ...
                                <a href="event-single.html" className="primary-hover fw-bold mt-4">EXPLORE MORE <i
                    ...
                    <div className="col-xl-6 wow fadeInDown" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div className="event__item h-100">
                            <div className="image h-100">
                                <img className="h-100" src="images/event/event-image2.jpg" alt="image"/>
                            </div>
                            <div className="event__content">
                                <ul className="mb-4">
                                    <li>
                                ...
                                <h3 className="mb-4"><a href="event-single.html" className="primary-hover">Rebecca's Charity
                                        Album A
                                        Brilliant
                                        Display</a>
                                </h3>
                    ...
                    <div className="col-xl-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div className="event__item h-100">
                            <div className="image h-100">
                                <img className="h-100" src="images/event/event-image3.jpg" alt="image"/>
                            </div>
                            <div className="event__content">
                                <ul className="mb-4">
                                    <li>
                    ...
                    <div className="col-xl-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div className="event__item h-100">
                            <div className="image h-100">
                                <img className="h-100" src="images/event/event-image4.jpg" alt="image"/>
                            </div>
                            <div className="event__content">
                                <ul className="mb-4">
                                    <li>
                                ...
                                <h3 className="mb-4"><a href="event-single.html" className="primary-hover">A Nation's
                                        Benevolence
                                        Displayed</a>
                                </h3>
                                <p>Embarrassing hidden in the middle of All the Lorem Ipsum generators on the Internet
        ...
        <section className="blog-area pt-120">
            <div className="container">
                <div className="section-header mb-60 text-center">
                    <h5 className="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <i className="fa-regular fa-angles-left pe-1"></i> Blog & news <i
                            className="fa-regular fa-angles-right ps-1"></i>
                    </h5>
                    <h2 className="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">Latest News Update</h2>
                </div>
                <div className="row g-4">
                    <div className="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div className="blog__item">
                            ...
                            <div className="blog__content pt-4">
                                ...
                                <h4 className="mt-20 pb-25 bor-bottom"><a href="blog-single.html"
                                        className="primary-hover">Rebecca's
                                        New
                                        Album
                                        Aid
                                        for the Needy</a></h4>
                                <a className="mt-4" href="blog-single.html"><span className="read-more fw-bold transition">Read
                                        More <i className="fa-solid fa-arrow-right ms-1"></i></span></a>
                            </div>
                        </div>
                    </div>
                    <div className="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div className="blog__item">
                            <div className="image">
                                ...
                                <span className="blog-tag">Foods</span>
                            </div>
                            <div className="blog__content pt-4">
                                <ul>
                                    <li>
                                ...
                                <h4 className="mt-20 pb-25 bor-bottom"><a href="blog-single.html"
                                        className="primary-hover">Provide
                                        Healthy
                    ...
                    <div className="col-xl-4 col-md-6 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <div className="blog__item">
                            <div className="image">
                                ...
                                <span className="blog-tag">Medical</span>
                            </div>
                            <div className="blog__content pt-4">
                                <ul>
                                    <li>
