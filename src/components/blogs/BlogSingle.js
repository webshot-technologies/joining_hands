  ...
  return (
    ...
    <main>
        ...
        <section class="banner__inner-page bg-image pt-160 pb-160 bg-image" style={{backgroundImage:"url('/images/banner/banner-inner-page.jpg')"}}
            >
            <div class="container">
                <h2 class="wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">Blog Single</h2>
                <div class="breadcrumb-list wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <a href="index.html">Home</a><span><i class="fa-regular fa-angles-right mx-2"></i>Blog Single</span>
                </div>
            </div>
        </section>
                ...
                <div class="row g-4">
                    <div class="col-lg-8 order-2 order-lg-1">
                        <div class="blog__item blog-single__left-item shadow-none">
                            <div class="image">
                                <img src="/images/blog/blog-single-image1.jpg" alt="image"/>
                        ...
                        <div class="blog-single__review mt-60">
                            ...
                            <div class="blog-single__comment d-flex gap-4 mt-60 pb-60 bor-bottom">
                                <div class="image">
                                    <img src="/images/blog/comment-image1.png" alt="image"/>
                                </div>
                                <div class="content">
                            ...
                            <div class="blog-single__comment d-flex gap-4 mt-60 pb-60 bor-bottom">
                                <div class="image">
                                    <img src="/images/blog/comment-image2.png" alt="image"/>
                                </div>
                                <div class="content">
                                    <div class="head d-flex flex-wrap gap-2 align-items-center justify-content-between">
                                        <div class="con">
